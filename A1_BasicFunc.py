...
def GenSingleOrder(order_index, customer, platform_exp_error = 1):
    pool = numpy.random.normal(customer.cook_info[1][0], customer.cook_info[1][1] * platform_exp_error, 1000)
    ...
    o = re_A1_class.Order(order_index, [customer.name], route, 'single', fee=customer.fee, parameter_info=None)
    return o
